...
class ReceiveOxyraAddressViewModel(
    private val wallet: Wallet,
    private val adapterManager: IAdapterManager
) : ViewModelUiState<ReceiveOxyraUiState>() {
    ...
    private suspend fun fetchAddress() {
        try {
            val adapter = adapterManager.getAdapterForWallet<OxyraAdapter>(wallet) ?: throw ReceiveOxyraError.NoAdapter
    ...
    override fun createState() = ReceiveOxyraUiState(
        viewState = viewState,
    ...
    class Factory(private val wallet: Wallet) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return ReceiveOxyraAddressViewModel(wallet, App.adapterManager) as T
        }
    }
}

sealed class ReceiveOxyraError : Throwable() {
    object NoAdapter : ReceiveOxyraError()
}

data class ReceiveOxyraUiState(
