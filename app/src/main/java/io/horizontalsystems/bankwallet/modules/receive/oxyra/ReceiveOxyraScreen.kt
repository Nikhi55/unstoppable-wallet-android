...
@Composable
fun ReceiveOxyraScreen(navController: NavController, wallet: Wallet, receiveEntryPointDestId: Int) {
    val addressViewModel = viewModel<ReceiveOxyraAddressViewModel>(factory = ReceiveOxyraAddressViewModel.Factory(wallet))
                ...
                RowUniversal(
                    ...
                    onClick = {
                        navController.slideFromRight(
                            R.id.oxyraSubaddressesFragment,
