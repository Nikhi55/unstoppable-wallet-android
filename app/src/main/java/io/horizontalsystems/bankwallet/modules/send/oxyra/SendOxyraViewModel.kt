...
class SendOxyraViewModel(
    val wallet: Wallet,
    private val sendToken: Token,
    val feeToken: Token,
    private val adapter: ISendOxyraAdapter,
    val coinMaxAllowedDecimals: Int,
    private val xRateService: XRateService,
    private val address: Address,
    private val showAddressInput: Boolean,
    private val amountService: SendAmountService,
    private val addressService: SendOxyraAddressService,
    private val feeService: SendOxyraFeeService,
    private val contactsRepo: ContactsRepository,
    private val recentAddressManager: RecentAddressManager,
) : ViewModelUiState<SendOxyraUiState>() {
    ...
    private val logger: AppLogger = AppLogger("send-oxyra")
    ...
    override fun createState() = SendOxyraUiState(
    ...
    private fun handleUpdatedAddressState(addressState: SendOxyraAddressService.State) {
    ...
    private fun handleUpdatedFeeState(feeState: SendOxyraFeeService.State) {
    ...
    private suspend fun send() = withContext(Dispatchers.IO) {
        try {
            ...
            recentAddressManager.setRecentAddress(addressState.address!!, OxyraBlockchainType)
        } catch (e: Throwable) {
