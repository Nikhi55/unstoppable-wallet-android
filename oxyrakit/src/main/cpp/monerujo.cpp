...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved) {
    ...
    class_TransactionInfo = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/model/TransactionInfo")));
    class_Transfer = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/model/Transfer")));
    class_WalletListener = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/model/WalletListener")));
    class_Ledger = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/ledger/Ledger")));
    class_WalletStatus = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/model/Wallet$Status")));
    class_BluetoothService = static_cast<jclass>(jenv->NewGlobalRef(
            jenv->FindClass("io/horizontalsystems/oxyrakit/service/BluetoothService")));
...
Java_io_horizontalsystems_oxyrakit_model_WalletManager_createWalletJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_openWalletJ(JNIEnv *env, jobject instance,
                                                          jstring path, jstring password,
                                                          jint networkType) {
    const char *_path = env->GetStringUTFChars(path, nullptr);
    const char *_password = env->GetStringUTFChars(password, nullptr);
...
extern "C"
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_recoveryWalletJ(
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_createWalletFromKeysJ(JNIEnv *env, jobject instance,
                                                                    jstring path, jstring password,
                                                                    jstring language,
                                                                    jint networkType,
                                                                    jlong restoreHeight,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_createWalletFromDeviceJ(JNIEnv *env, jobject instance,
                                                                      jstring path,
                                                                      jstring password,
                                                                      jint networkType,
                                                                      jstring deviceName,
...
Java_io_horizontalsystems_oxyrakit_model_WalletManager_walletExists(JNIEnv *env, jobject instance,
                                                           jstring path) {
    const char *_path = env->GetStringUTFChars(path, nullptr);
    bool exists =
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_verifyWalletPassword(JNIEnv *env, jobject instance,
...
Java_io_horizontalsystems_oxyrakit_model_WalletManager_queryWalletDeviceJ(JNIEnv *env, jobject instance,
                                                                 jstring keys_file_name,
                                                                 jstring password) {
    const char *_keys_file_name = env->GetStringUTFChars(keys_file_name, nullptr);
    const char *_password = env->GetStringUTFChars(password, nullptr);
...
Java_io_horizontalsystems_oxyrakit_model_WalletManager_findWallets(JNIEnv *env, jobject instance,
                                                          jstring path) {
    const char *_path = env->GetStringUTFChars(path, nullptr);
...
Java_io_horizontalsystems_oxyrakit_model_WalletManager_setDaemonAddressJ(JNIEnv *env, jobject instance,
                                                                jstring address) {
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getDaemonVersion(JNIEnv *env,
                                                               jobject instance) {
    uint32_t version;
    bool isConnected =
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getBlockchainHeight(JNIEnv *env, jobject instance) {
    return Monero::WalletManagerFactory::getWalletManager()->blockchainHeight();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getBlockchainTargetHeight(JNIEnv *env,
                                                                        jobject instance) {
    return Monero::WalletManagerFactory::getWalletManager()->blockchainTargetHeight();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getNetworkDifficulty(JNIEnv *env, jobject instance) {
    return Monero::WalletManagerFactory::getWalletManager()->networkDifficulty();
}

JNIEXPORT jdouble JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getMiningHashRate(JNIEnv *env, jobject instance) {
    return Monero::WalletManagerFactory::getWalletManager()->miningHashRate();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_getBlockTarget(JNIEnv *env, jobject instance) {
    return Monero::WalletManagerFactory::getWalletManager()->blockTarget();
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_isMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Monero::WalletManagerFactory::getWalletManager()->isMining());
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_startMining(JNIEnv *env, jobject instance,
                                                          jstring address,
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_stopMining(JNIEnv *env, jobject instance) {
    return static_cast<jboolean>(Monero::WalletManagerFactory::getWalletManager()->stopMining());
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_resolveOpenAlias(JNIEnv *env, jobject instance,
                                                               jstring address,
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_setProxy(JNIEnv *env, jobject instance,
                                                       jstring address) {
    const char *_address = env->GetStringUTFChars(address, nullptr);
    bool rc =
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_closeJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getSeed(JNIEnv *env, jobject instance, jstring seedOffset) {
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getSeedLanguage(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->getSeedLanguage().c_str());
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setSeedLanguage(JNIEnv *env, jobject instance,
                                                       jstring language) {
    const char *_language = env->GetStringUTFChars(language, nullptr);
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getStatusJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jobject JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_statusWithErrorString(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setPassword(JNIEnv *env, jobject instance,
                                                   jstring password) {
    const char *_password = env->GetStringUTFChars(password, nullptr);
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getAddressJ(JNIEnv *env, jobject instance,
                                                   jint accountIndex,
                                                   jint addressIndex) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getPath(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->path().c_str());
}

JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_nettype(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getIntegratedAddress(JNIEnv *env, jobject instance,
                                                            jstring payment_id) {
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getSecretViewKey(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretViewKey().c_str());
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getSecretSpendKey(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->secretSpendKey().c_str());
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getPublicViewKey(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->publicViewKey().c_str());
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getPublicSpendKey(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return env->NewStringUTF(wallet->publicSpendKey().c_str());
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_store(JNIEnv *env, jobject instance,
                                             jstring path) {
    const char *_path = env->GetStringUTFChars(path, nullptr);
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getFilename(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_initJ(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setRestoreHeight(JNIEnv *env, jobject instance,
                                                        jlong height) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getRestoreHeight(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getConnectionStatusJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->connected();
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setTrustedDaemon(JNIEnv *env, jobject instance, jboolean isTrusted) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_trustedDaemon(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->trustedDaemon());
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setProxy(JNIEnv *env, jobject instance,
                                                jstring address) {
    const char *_address = env->GetStringUTFChars(address, nullptr);
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getBalance(JNIEnv *env, jobject instance,
                                                  jint accountIndex) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getBalanceAll(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->balanceAll();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getUnlockedBalance(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getUnlockedBalanceAll(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->unlockedBalanceAll();
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_isWatchOnly(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->watchOnly());
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getBlockChainHeight(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->blockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getApproximateBlockChainHeight(JNIEnv *env,
                                                                      jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getDaemonBlockChainHeight(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->daemonBlockChainHeight();
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getDaemonBlockChainTargetHeight(JNIEnv *env,
                                                                       jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_isSynchronizedJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->synchronized());
}

JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getDeviceTypeJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
Java_io_horizontalsystems_oxyrakit_util_KeyStoreHelper_slowHash(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getDisplayAmount(JNIEnv *env, jclass clazz,
                                                        jlong amount) {
    return env->NewStringUTF(Monero::Wallet::displayAmount(amount).c_str());
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getAmountFromString(JNIEnv *env, jclass clazz,
                                                           jstring amount) {
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getAmountFromDouble(JNIEnv *env, jclass clazz,
                                                           jdouble amount) {
    return Monero::Wallet::amountFromDouble(amount);
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_generatePaymentId(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(Monero::Wallet::genPaymentId().c_str());
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_isPaymentIdValid(JNIEnv *env, jclass clazz,
                                                        jstring payment_id) {
    const char *_payment_id = env->GetStringUTFChars(payment_id, nullptr);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_isKeyValid(JNIEnv *env, jclass clazz, jstring secret_key, jstring address, jboolean is_view_key, jint networkType) {
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_isAddressValid(JNIEnv *env, jclass clazz,
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getPaymentIdFromAddress(JNIEnv *env, jclass clazz,
                                                               jstring address,
                                                               jint networkType) {
    Monero::NetworkType _networkType = static_cast<Monero::NetworkType>(networkType);
    const char *_address = env->GetStringUTFChars(address, nullptr);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getMaximumAllowedAmount(JNIEnv *env, jclass clazz) {
    return Monero::Wallet::maximumAllowedAmount();
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_startRefresh(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    wallet->startRefresh();
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_pauseRefresh(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    wallet->pauseRefresh();
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_refresh(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return static_cast<jboolean>(wallet->refresh());
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_refreshAsync(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    wallet->refreshAsync();
}
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_rescanBlockchainAsyncJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_createTransactionMultDest(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_createTransactionJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_createSweepTransaction(JNIEnv *env, jobject instance,
                                                              jstring dst_addr, jstring payment_id,
                                                              jint mixin_count,
                                                              jint priority,
                                                              jint accountIndex) {
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_createSweepUnmixableTransactionJ(JNIEnv *env,
                                                                        jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_disposeTransaction(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_estimateTransactionFee(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getHistoryJ(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setListenerJ(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getDefaultMixin(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->defaultMixin();
}

JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setDefaultMixin(JNIEnv *env, jobject instance, jint mixin) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
    return wallet->setDefaultMixin(mixin);
}

JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setUserNote(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getUserNote(JNIEnv *env, jobject instance,
                                                   jstring txid) {
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getTxKey(JNIEnv *env, jobject instance,
                                                jstring txid) {
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_addAccount(JNIEnv *env, jobject instance,
                                                  jstring label) {
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getSubaddressLabel(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_setSubaddressLabel(JNIEnv *env, jobject instance,
                                                          jint accountIndex, jint addressIndex,
                                                          jstring label) {
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getNumAccounts(JNIEnv *env, jobject instance) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getNumSubaddresses(JNIEnv *env, jobject instance,
                                                          jint accountIndex) {
    Monero::Wallet *wallet = getHandle<Monero::Wallet>(env, instance);
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_addSubaddress(JNIEnv *env, jobject instance,
                                                     jint accountIndex,
                                                     jstring label) {
...
/*JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_Wallet_getLastSubaddress(JNIEnv *env, jobject instance,
                                                         jint accountIndex) {
...
// TransactionHistory
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_TransactionHistory_getCount(JNIEnv *env, jobject instance) {
...
JNIEXPORT jobject JNICALL
Java_io_horizontalsystems_oxyrakit_model_TransactionHistory_refreshJ(JNIEnv *env, jobject instance,
                                                            jint accountIndex) {
    Monero::TransactionHistory *history = getHandle<Monero::TransactionHistory>(env,
                                                                                instance);
    history->refresh();
...
JNIEXPORT jint JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getStatusJ(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
    return tx->status();
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getErrorString(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
...
JNIEXPORT jboolean JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_commit(JNIEnv *env, jobject instance,
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getAmount(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
    return static_cast<jlong>(tx->amount());
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getDust(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
    return static_cast<jlong>(tx->dust());
}

JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getFee(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
...
JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getFirstTxIdJ(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_io_horizontalsystems_oxyrakit_model_PendingTransaction_getTxCount(JNIEnv *env, jobject instance) {
    Monero::PendingTransaction *tx = getHandle<Monero::PendingTransaction>(env, instance);
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_initLogger(JNIEnv *env, jclass clazz,
                                                         jstring argv0,
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_logDebug(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_logInfo(JNIEnv *env, jclass clazz,
                                                      jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_logWarning(JNIEnv *env, jclass clazz,
                                                         jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_logError(JNIEnv *env, jclass clazz,
                                                       jstring category, jstring message) {
...
JNIEXPORT void JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_setLogLevel(JNIEnv *env, jclass clazz,
                                                          jint level) {
    Monero::WalletManagerFactory::setLogLevel(level);
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_moneroVersion(JNIEnv *env, jclass clazz) {
    return env->NewStringUTF(MONERO_VERSION);
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_generateKey(JNIEnv *env, jclass clazz, jstring seed, jstring seed_offset, jboolean private_key, jboolean spend_key) {
    // generateKey not available in Oxyrax wallet_api
    return env->NewStringUTF("");
}

JNIEXPORT jstring JNICALL
Java_io_horizontalsystems_oxyrakit_model_WalletManager_generateAddress(JNIEnv *env, jclass clazz, jstring seed, jstring seed_offset, jint account_index, jint address_index,  jboolean testnet) {
    // generateAddress not available in Oxyrax wallet_api
    return env->NewStringUTF("");
}
